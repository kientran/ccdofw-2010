...
<?php
$loop = new WP_Query( array( 'post_type' => 'volunteer-posting', 'posts_per_page' => 10 ) );
...
<?php
$id = $post->ID;
$program = get_post_meta($id, 'volunteer-interest', true);
$postingdate = get_post_meta($id, 'volunteer-posting', true);
$expires = get_post_meta($id, 'volunteer-expires', true);
$summary = get_post_meta($id, 'volunteer-goal', true);
